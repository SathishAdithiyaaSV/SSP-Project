...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in services/reservation/proto/reservation_pb2_grpc.py depends on'
...
def add_ReservationServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('reservation.Reservation', rpc_method_handlers)
